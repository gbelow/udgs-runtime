...
// is the one who holds it's to roll. A charged spell produces nothing now:
// "activates an object that stays charged", and what it does waits in the
// object until the charge is released.
